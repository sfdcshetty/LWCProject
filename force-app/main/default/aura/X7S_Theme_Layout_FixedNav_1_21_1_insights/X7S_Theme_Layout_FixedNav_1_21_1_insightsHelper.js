/*--
  ...
  ({
    handleFixedNav: function(component, event, helper) {
        ...
        if (component.find("dataPinnable") && component.find("dataPinnable").getElement) {
            pinElement = component.find("dataPinnable").getElement();
        }
        if (component.find("dataRemovePinnable") && component.find("dataRemovePinnable").getElement) {
