({
    doInit : function (component, event, helper) {
        ...
        var type = '';
        if (!component.get ('v.recordId').startsWith ('001')) {
            type = 'Version';
    ...
    createRecord : function (component, event, helper) {
        ...
        if (component.get ('v.recordId').startsWith ('001')) {
            ...
            cloudFile['TVA_CFB__Account__c'] = component.get ('v.recordId');
        ...
        action.setCallback(this, function(response){
            ...
            if (component.isValid() && state === "SUCCESS") {
                ...
                if (result != null) {
                    ...
                    var ddpId = $A.get ("$Label.c.DDPId");
                    var deliveryOptionId = $A.get ("$Label.c.DeliveryOptionId");
