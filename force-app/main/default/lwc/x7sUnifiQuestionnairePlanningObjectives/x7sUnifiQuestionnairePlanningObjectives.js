...
//import UNIFI_OBJECT from '@salesforce/schema/WEG_Unifi_Questionnaire__c';
import HEADER from '@salesforce/label/c.x7sUnifiQuestionnaire_PlanningObjectives_Header';

import {api,LightningElement } from 'lwc';

export default class X7sUnifiQuestionnairePlanningObjectives extends LightningElement {
    @api debug = false;
