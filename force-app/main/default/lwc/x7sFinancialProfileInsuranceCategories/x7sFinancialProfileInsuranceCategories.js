import HEADER from '@salesforce/label/c.x7sFinancialProfile_InsuranceCategories_Header';
import { api, LightningElement } from 'lwc';

export default class X7sFinancialProfileInsuranceCategories extends LightningElement {
    @api debug = false;
    @api primaryName = '';
    @api secondaryName = '';
    header = HEADER;
